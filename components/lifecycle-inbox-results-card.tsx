    ...
    <div className="bg-[#0a0806] px-6 py-16 text-white md:px-10 md:py-20">
      <div className="mx-auto max-w-[1400px]">
        <div className="mb-10 text-center">
          <p className="text-sm uppercase tracking-[0.28em] text-[#d7c8b4]/80">
            Results & Testimonials
          </p>
          <h2 className="mt-4 text-[2.5rem] font-semibold tracking-[-0.04em] text-white md:text-[3.5rem]">
            Results that feel as credible as they look
          </h2>
        </div>
          ...
          <div className="relative grid gap-8 px-8 py-10 lg:grid-cols-[0.48fr_0.52fr] lg:px-12 lg:py-12">
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-4 lg:grid-cols-[1.4fr_1fr]">
                <div className="rounded-[30px] border border-white/10 bg-[#120a05] p-5">
                  <div className="relative h-[260px] overflow-hidden rounded-[26px] border border-white/10 bg-[#000]">
                    <Image
                  ...
                  <div className="mt-5">
                    <p className="text-sm leading-6 text-[#d8c8b5]">
                      “The impact on email revenue and customer retention was immediately visible, and the result card image made the story easy to share.”
                    </p>
                    <p className="mt-4 font-semibold text-[#f4efe8]">— Growth Lead, skincare brand</p>
                  </div>
                </div>
